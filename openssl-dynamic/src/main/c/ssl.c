...
{
#if !defined(OPENSSL_IS_BORINGSSL) && (OPENSSL_VERSION_NUMBER < 0x10100000L) || defined(OPENSSL_USE_DEPRECATED)
    if (!(SSL_temp_keys[idx] =
...
static jlong createNetworkBIO(JNIEnv *e, jlong ssl, jint max_bio_size) {
...
TCN_IMPLEMENT_CALL(jlong, SSL, makeNetworkBIO)(TCN_STDARGS,
                                               jlong ssl /* SSL * */) {
    UNREFERENCED(o);
    return createNetworkBIO(e, ssl, 0);
}
...
TCN_IMPLEMENT_CALL(jlong, SSL, makeNetworkBIOWithSize)(TCN_STDARGS,
                                               jlong ssl /* SSL * */,
                                               jint max_bio_size) {
    UNREFERENCED(o);
    return createNetworkBIO(e, ssl, max_bio_size);
}
